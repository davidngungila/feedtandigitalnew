...
<div class="animate-[fadeIn_0.4s_ease] space-y-4 flex flex-col items-center justify-center min-h-[80vh]">
    <div class="mb-8">
        <div class="relative mx-auto w-48 h-48">
            <div class="absolute inset-0 bg-purple-500/10 dark:bg-purple-500/10 rounded-full animate-pulse"></div>
            <div class="relative flex items-center justify-center w-full h-full">
                <span class="text-[120px] font-extrabold text-purple-600 dark:text-purple-400 leading-none">429</span>
            </div>
        </div>
    </div>
    
    <h1 class="text-3xl font-bold text-[#064e3b] dark:text-[#ecfdf5] mb-4 text-center">Too Many Requests</h1>
    
    <p class="text-[#6b7280] dark:text-[#6ee7b7] mb-8 text-sm leading-relaxed text-center max-w-md">
        Sorry, you've made too many requests. Please try again later.
    </p>
