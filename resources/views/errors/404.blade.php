...
<div class="animate-[fadeIn_0.4s_ease] space-y-4 flex flex-col items-center justify-center min-h-[80vh]">
    <div class="mb-8">
        <div class="relative mx-auto w-48 h-48">
            <div class="absolute inset-0 bg-[#064e3b]/10 dark:bg-[#10b981]/10 rounded-full animate-pulse"></div>
            <div class="relative flex items-center justify-center w-full h-full">
                <span class="text-[120px] font-extrabold text-[#064e3b] dark:text-[#10b981] leading-none">404</span>
            </div>
        </div>
    </div>
    
    <h1 class="text-3xl font-bold text-[#064e3b] dark:text-[#ecfdf5] mb-4 text-center">Page Not Found</h1>
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <button onclick="window.history.back()" class="px-6 py-3 rounded-xl border-2 border-[#064e3b] dark:border-[#10b981] text-[#064e3b] dark:text-[#10b981] hover:bg-[#064e3b]/10 dark:hover:bg-[#10b981]/10 text-sm font-semibold transition-all duration-200">
