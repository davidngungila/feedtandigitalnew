...
<div class="animate-[fadeIn_0.4s_ease] space-y-4 flex flex-col items-center justify-center min-h-[80vh]">
    <div class="mb-8">
        <div class="relative mx-auto w-48 h-48">
            <div class="absolute inset-0 bg-yellow-500/10 dark:bg-yellow-500/10 rounded-full animate-pulse"></div>
            <div class="relative flex items-center justify-center w-full h-full">
                <span class="text-[120px] font-extrabold text-yellow-600 dark:text-yellow-400 leading-none">419</span>
            </div>
        </div>
    </div>
    
    <h1 class="text-3xl font-bold text-[#064e3b] dark:text-[#ecfdf5] mb-4 text-center">Page Expired</h1>
