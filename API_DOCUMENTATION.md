...
**Endpoint**: `POST /member/check-email`
...
**Endpoint**: `POST /member/login-first`
...
**Endpoint**: `POST /member/login-pin`
...
4. **First Time Login (Password & Set PIN) Screen**
